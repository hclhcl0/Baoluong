...
import {
  Upload, Send, X, CheckCircle, XCircle,
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-400 text-xs max-w-[200px] truncate">{fileName}</span>
                    </div>
        ...
        <div className="p-6 space-y-4">
          ...
          >
            {isSending ? (
              ...
              <><Send className="w-5 h-5 mr-2" /> Bắt đầu gửi {selectedCount} email</>
            )}
          </Button>
        </div>
      </section>
